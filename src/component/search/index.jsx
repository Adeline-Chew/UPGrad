...
const AddressInput = ({ inputValue, handleInput }) => (
    <input
        ...
        type="text"
        placeholder="Enter City, Location, Country"
        value={inputValue}
...
const AgentInput = ({ inputValue, handleInput }) => (
    <input
        className="common filter-search"
        type="text"
        placeholder="Enter Company Name, Organization"
        value={inputValue}
        onChange={handleInput}
    />
);
...
class FilterSearch extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <select className="common select" onChange={this.handleSelectChange}>
          <option value="Address">By Location</option>
          <option value="Agent">By Company Name</option>
        </select>
                {this.renderInput()}
