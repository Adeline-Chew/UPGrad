  ...
  <div className="container">
    <div className="row">
      <div className="col-md-4 bg-white ">
        <h4 style={{ height: 40, fontSize: '30px', marginTop:'20px', marginLeft:'20px', fontWeight: '600'}}>
          All Chats
        </h4>
        
        {/* =============================================================== */}
        {/* member list */}
        <ul className="friend-list" style={{ marginTop:'20px'}}>
          <li className="active bounceInDown">
            <a href="#" className="clearfix">
              ...
              <p className="chat-alert label label-danger">3</p>
            </a>
          </li>
          <li>
            <a href="#" className="clearfix">
          ...
          <li>
            <a href="#" className="clearfix">
              ...
              <small className="time text-muted">3 hours agp</small>
              <small className="chat-alert text-muted">
                <i className="fa fa-reply" />
              </small>
            </a>
          ...
          <li>
            <a href="#" className="clearfix">
              ...
              <small className="time text-muted">8 hours ago</small>
              <small className="chat-alert text-muted">
                <i className="fa fa-reply" />
              </small>
            </a>
          ...
          <li>
            <a href="#" className="clearfix">
              ...
              <small className="time text-muted">Wednesday</small>
              <small className="chat-alert text-muted">
                <i className="fa fa-check" />
              </small>
            </a>
      ...
      {/*=========================================================*/}
      {/* selected chat */}
      <div className="col-md-8 bg-white " style={{height:"100%"}}>
        <div className="chat-message" style={{height:"90vh"}}>
          <ul className="chat" >
            <li className="left clearfix">
              ...
              <div className="chat-body clearfix">
                ...
                <p style={{fontSize: '20px'}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
              </div>
            </li>
            <li className="right clearfix">
              ...
              <div className="chat-body clearfix">
                <div className="header">
                  <strong className="primary-font">Justin</strong>
                  <small className="pull-right text-muted">
            ...
            <li className="right clearfix">
              ...
              <div className="chat-body clearfix">
                <div className="header">
                  <strong className="primary-font">Justin</strong>
                  <small className="pull-right text-muted">
                    <i className="fa fa-clock-o" /> 10 mins ago
                  </small>
                </div>
                <p style={{fontSize: '20px'}}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        {/* <div className="chat-box bg-white" style={{width: "100%", marginTop:'120px', position: "fixed", bottom: 0, overflow:"hidden"}}>
